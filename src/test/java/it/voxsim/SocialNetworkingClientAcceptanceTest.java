...
import it.voxsim.message.EnhancedCalendar;
...
public class SocialNetworkingClientAcceptanceTest {
	...
	public void readMessagesFromBobAfterHePostedOneMessage() throws Exception {
		GregorianCalendar timeRead = new EnhancedCalendar();
		GregorianCalendar timePosting = new EnhancedCalendar(timeRead, 2 * ONE_MINUTE);
	...
	public void readMessagesFromBobAfterHePostedTwoMessages() throws Exception {
		GregorianCalendar timeRead = new EnhancedCalendar();
		GregorianCalendar timePosting = new EnhancedCalendar(timeRead, 2 * ONE_MINUTE);
		GregorianCalendar timeSecondPosting = new EnhancedCalendar(timeRead, 1 * ONE_MINUTE);
	...
	public void showWallAfterComplexScenario() throws Exception {
		GregorianCalendar timeRead = new EnhancedCalendar();
		GregorianCalendar timePosting = new EnhancedCalendar(timeRead, 5 * ONE_MINUTE);
		GregorianCalendar timeSecondPosting = new EnhancedCalendar(timeRead, 15 * ONE_SECOND);
	...
	public void CharlieCanSubscribeToAlicesAndBobsTimelinesAndViewAnAggregatedListOfAllSubscriptions() throws Exception {
		GregorianCalendar time1 = new EnhancedCalendar();
		GregorianCalendar time2 = new EnhancedCalendar(time1, 5 * ONE_MINUTE);
		GregorianCalendar time3 = new EnhancedCalendar(time1, 2 * ONE_MINUTE);
		GregorianCalendar time4 = new EnhancedCalendar(time1, 1 * ONE_MINUTE);
		GregorianCalendar time5 = new EnhancedCalendar(time1, 2 * ONE_SECOND);
