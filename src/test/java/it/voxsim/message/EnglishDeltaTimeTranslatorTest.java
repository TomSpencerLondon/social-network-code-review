...
public class EnglishDeltaTimeTranslatorTest {
	...
	public void oneSecondAgo() {
		...
		Calendar endTime = new GregorianCalendar();
		Calendar startTime = new EnhancedCalendar(endTime, ONE_SECOND);
	...
	public void oneMinuteAgo() {
		...
		Calendar endTime = new GregorianCalendar();
		Calendar startTime = new EnhancedCalendar(endTime, ONE_MINUTE);
	...
	public void oneHourAgo() {
		...
		Calendar endTime = new GregorianCalendar();
		Calendar startTime = new EnhancedCalendar(endTime, ONE_HOUR);
	...
	public void oneDayAgo() {
		...
		Calendar endTime = new GregorianCalendar();
		Calendar startTime = new EnhancedCalendar(endTime, ONE_DAY);
